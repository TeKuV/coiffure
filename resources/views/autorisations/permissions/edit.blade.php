                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5> Mise à jour <small> de la permission.</small></h5>
                        ...
                        <div class="ibox-content">
                            ...
                            @method('PUT')
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Titre</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" value="{{$permission->intitule}}" name="intitule"></div>
                                </div>
                                <div class="hr-line-dashed"></div>

                                <div class="form-group"><label class="col-sm-2 control-label">Description</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" value="{{$permission->detail}}" name="detail"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
