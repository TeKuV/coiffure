  ...
  <section class="ftco-section">
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(images/doctor-5.jpg);">
                <div class="box">
                  <h2>Aldin Powell</h2>
                  <p>Neurologist</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <div class="img" style="background-image: url(images/doctor-5.jpg);"></div>
                  </div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(images/doctor-6.jpg);">
                <div class="box">
                  <h2>Aldin Powell</h2>
                  <p>Pediatrician</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <div class="img" style="background-image: url(images/doctor-6.jpg);"></div>
                  </div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(images/portrait-of-beautiful3.jpg);">
                <div class="box">
                  <h2>Aldin Powell</h2>
                  <p>Ophthalmologist</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <div class="img" style="background-image: url(images/portrait-of-beautiful3.jpg);"></div>
                  </div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(images/portrait-of-beautiful5.jpg);">
                <div class="box">
                  <h2>Aldin Powell</h2>
                  <p>Pulmonologist</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <div class="img" style="background-image: url(images/portrait-of-beautiful5.jpg);"></div>
                  </div>
